...
acervo/                  # pacote de domínio — NADA de Streamlit aqui
  ...
  core/
    models.py            # dataclasses: Categoria, Arquivo, Bloco, ResultadoBusca…
    exceptions.py        # hierarquia AcervoError (Configuracao, ConexaoBanco, Parse, Busca, Upload)
  ingestion/
  ...
  persistence/
    ...
    migrations/          # 0001 schema, 0002 busca sem acento, 0003 coluna origem
...
app/                     # interface Streamlit — SÓ apresentação
  streamlit_app.py       # entrada: navbar + roteamento de páginas
